  ...
  <div id="container">
    ...
    <?php include($DOCUMENT_ROOT.'includes/header.inc'); ?>
      ...
      <a href="/"><img id="logo" alt="Chicago Line Cruises Home Page" width="100" height="99" src="/assets/images/home-logo.png"></a>
  		...
  		<article>
        <h1>If the Centennial Fountain was pointed in the<br>
        opposite direction, we&rsquo;d get soaked.</h1>
  			<p>Our boats and ticket office are located just north of the Fountain<br>
        at 465 McClurg Court on a hidden branch of the Chicago River called<br>
        the &ldquo;Ogden Slip.&rdquo; Click here for <a href="/downloads/Directions to 465 McClurg Court.pdf" target="_blank">map and directions</a>.</p>
  		</article>
