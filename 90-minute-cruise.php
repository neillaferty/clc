  ...
  <div id="container">
    ...
    <?php include($DOCUMENT_ROOT.'includes/header.inc'); ?>
      ...
      <a href="/"><img id="logo" alt="Chicago Line Cruises Home Page" width="100" height="99" src="/assets/images/home-logo.png"></a>
  		...
  		<article>
  			<p>Throughout our signature<br>
        90 minute cruise our professional<br> 
        <a href="/architectural-cruise-detail.php">docent</a> will present more than<br>
        50 skyscrapers, bascule bridges,<br>
        and historic sites. Passage<br>
        is $42 / adult, $35 / ages 65+,<br>
        $20 / ages 7-18, plus tax.</p>

        <p><a href="/architectural-cruise-detail.php">Learn More</a></p>
  		</article>
      ...
      <figcaption>Willis (formerly Sears) Tower and neighbors</figcaption>
